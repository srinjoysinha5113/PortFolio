...
const Intro: React.FC<IntroProps> = ({ setActiveSection }) => {
  const handleContactClick = (type: string) => {
    if (type === "github") {
      window.open("https://github.com/srinjoysinha5113", '_blank')
    } else if (type === "linkedin") {
      window.open("https://www.linkedin.com/in/srinjoy-sinha-508963276/", '_blank')
    } else if (type === "resume") {
      window.open('/src/assets/Srinjoy_Sinha_Resume.pdf', '_blank')
    }
  }
    ...
    <section id="intro" className="section pt-24 mb-24">
      <div className="container mx-auto px-6">
        <div className="text-left mt-12 mb-12">
          ...
          <div className="hero-heading mb-6 text-left mt-6">
            SRINJOY SINHA
          </div>
          ...
          <div className="flex justify-start items-center gap-8 mt-6 mb-12">
            <button
